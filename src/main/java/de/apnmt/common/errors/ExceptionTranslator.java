...
public class ExceptionTranslator implements ProblemHandling {
    ...
    @ExceptionHandler
    public ResponseEntity<Problem> handleHttpError(HttpError error, NativeWebRequest request) {
        Problem problem = Problem.builder().withStatus(error.getStatus()).withTitle(error.getMessage()).withDetail(error.getKey()).build();
